              ...
              <div className="flex flex-wrap justify-between gap-2">
                ...
                <div>
                  <button
                    ...
                    onClick={() => setIsActive((prev) => (prev.length === 0 ? courseContent.map((_, i) => i) : []))}
                  >
                    {isActive.length === 0 ? "Expand all sections" : "Collapse all sections"}
                  </button>
                </div>
              </div>
            </div>

            <div className="my-4 h-[1px] bg-richblack-500"></div>
            <div>
              {courseContent?.map((section, index) => (
                <CourseAccordionBar
                  key={index}
                  section={section}
                  isActive={isActive.includes(index)}
